...
// import { Template } from "../tests/pages/CaseAPI/issueFinalDecision/selectTemplatePage.ts";
// import createDraft from "./createDraft.ts";
// import editDraftOrderPage from "../tests/pages/CaseAPI/editDraft/editDraftOrderPage.ts";
// import editDraftOrderMainContentPage from "../tests/pages/CaseAPI/editDraft/editDraftOrderMainContentPage.ts";
// import editDraftAddDocumentFooterPage from "../tests/pages/CaseAPI/editDraft/editDraftAddDocumentFooterPage.ts";
// import editDraftPreviewTemplatePage from "../tests/pages/CaseAPI/editDraft/editDraftPreviewTemplatePage.ts";
// import submitPage from "../tests/pages/CaseAPI/editDraft/submitPage.ts";
// import confirmPage from "../tests/pages/CaseAPI/editDraft/confirmPage.ts";
// import ordersAndDecisionsTabPage from "../tests/pages/CaseAPI/caseTabs/ordersAndDecisionsTabPage.ts";
//
// type EditDraft = {
//   editDraft(
//     page: Page,
