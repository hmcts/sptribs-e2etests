...
// import editCICACaseDetailsEditCaseDetailsPage from "../tests/pages/CaseAPI/editCICACaseDetails/editCICACaseDetailsEditCaseDetailsPage.ts";
// import submitPage from "../tests/pages/CaseAPI/editCICACaseDetails/submitPage.ts";
// import confirmPage from "../tests/pages/CaseAPI/editCICACaseDetails/confirmPage.ts";
// import CICADetailsTabPage from "../tests/pages/CaseAPI/caseTabs/CICADetailsTabPage.ts";
//
// type initialState =
//   | "Case Management"
//   | "Awaiting hearing"
