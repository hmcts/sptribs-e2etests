const uploadDocumentsContent = {
  ...
  hintText:
    "Please provide any additional relevant information that you would like to add to this case. Don't include personal financial information, such as your banking details.",
  ...
  exceedsFileSizeError:
    "File size exceeds the maximum permitted value. Please upload a file that is less than 20MB (documents) or less than 30MB (multimedia files)",
};
