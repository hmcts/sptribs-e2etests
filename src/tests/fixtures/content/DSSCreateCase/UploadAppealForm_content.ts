const uploadAppealForm_content = {
  ...
  welshPageTitle: "Llwytho ffurflen y tribiwnlys",
  welshTextOnPage1:
    "Llwythwch ffurflen y Tribiwnlys Haen Gyntaf rydych wedi’i llenwi’n barod.",
  welshTextOnPage2:
  ...
  welshNoUploadError: "Ni allwch barhau heb lwytho’r cais",
  welshFileTypeError:
