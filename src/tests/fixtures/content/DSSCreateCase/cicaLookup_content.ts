const cicaLookupContent = {
  ...
  hintText1:
    "If you have an existing appeal, entering your HMCTS reference number will take you to it. If you do not have a reference number, a new appeal will need to be submitted.",
  hintText2:
