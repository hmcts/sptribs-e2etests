const uploadSupportingDocuments_content = {
  ...
  pageTitleCy: "Llwytho dogfennau ategol",
  textOnPageCy1:
  ...
  textOnPageCy6: "Llwythwch ffeil i fyny",
  textOnPageCy7:
...
export default uploadSupportingDocuments_content;
