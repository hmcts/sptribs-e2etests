...
import cicaConfirmNewPage from "../../pages/DSSCreateCase/cicaConfirmNewPage.ts";
  ...
  async createFEApplication(
    ...
    switch (errorMessaging) {
      ...
      case true:
        ...
        await cicaLookupPage.fillInFields(page, "1234123412341234");
        await cicaConfirmNewPage.checkPageLoads(page, cy, accessibilityTest);
        await cicaConfirmNewPage.fillInFields(page, true);
