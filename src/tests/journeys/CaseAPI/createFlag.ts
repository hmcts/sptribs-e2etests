...
const createFlag: CreateFlag = {
  async createFlag(
    ...
    switch (initialState) {
      default:
        throw new Error("Invalid state, create a flag from this state.");
    ...
    switch (user) {
      default: //Defaults to caseWorker
        ...
        await createFlags3Page.checkPageLoadsReasonableAdjustment(
          page,
          false,
          caseNumber,
        );
        await createFlags3Page.selectAdjustmentType(
          page,
          " I need documents in an alternative format ",
        );
        await createFlags4Page.checkPageLoadsReasonableAdjustAltFormat(
          page,
          false,
          caseNumber,
        );
        await createFlags4Page.selectAdjustmentType(
          page,
        ...
        await submitPage.checkSummaryInfo(
          page,
          caseApplicantDetailsObject_content.name,
          " Documents in a specified colour ",
        );
