...
const amendDocumentsPage : AmendCaseDocumentsPage = {
  ...
  async checkPageLoads(
    ...
    await Promise.all([
      ...
      expect(page.locator('label[for="cicCaseSelectedDocument_documentCategory"] span.form-label.ng-star-inserted')).toContainText(
        amendCaseDocuments_content.textOnPage2,
      ),
      expect(page.locator('label[for="cicCaseSelectedDocument_documentEmailContent"] span.form-label.ng-star-inserted')).toContainText(
        amendCaseDocuments_content.textOnPage3,
      ),
      expect(page.locator('#cicCaseSelectedDocument_documentCategory')).toBeVisible(),
      commonHelpers.checkForButtons(page, this.continue, this.previous, this.cancel),
    ]);
