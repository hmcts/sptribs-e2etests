...
type StatePage = {
  caseStateTab: string;
  caseTasksTab: string;
  checkStateBeforeTaskCompletion(page: Page,accessibilityTest: boolean, caseNumber: string, stateBeforeCompletion: string): Promise<void>;
  checkStateAfterTaskCompletion(page: Page, stateAfterCompletion: string): Promise<void>;
};
...
const statePage: StatePage = {
  ...
  async checkStateBeforeTaskCompletion(page: Page, accessibilityTest: boolean, caseNumber: string, stateBeforeCompletion: string): Promise<void> {
  ...
  async checkStateAfterTaskCompletion(page: Page, stateAfterCompletion: string): Promise<void> {
    await page.locator(this.caseStateTab).click();
    await page.waitForURL(/.*\#State$/);
