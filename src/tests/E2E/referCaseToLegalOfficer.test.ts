...
test.describe("Case-API Refer case to legal officer tests. @CaseAPI ", () => {
  ...
  test("Refer case to legal officer - ready to list, rule 27 request @CaseAPI2", async ({
    page,
  }): Promise<void> => {
    const subjectName = `Subject AutoTesting${commonHelpers.randomLetters(5)}`;
  ...
  test("Refer case to legal officer - case stayed, strike out request @CaseAPI2", async ({
    page,
  }): Promise<void> => {
    const subjectName = `Subject AutoTesting${commonHelpers.randomLetters(5)}`;
